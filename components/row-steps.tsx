        ...
        >
          {steps?.map((step, stepIdx) => {
            ...
            return (
              <li
                key={stepIdx}
                className="relative flex w-full items-center pr-12 last:pr-0"
              >
                <button
                  key={stepIdx}
                  ref={ref}
                  ...
                  className={cn(
                    `group flex w-full ${disableManualStepChange ? "" : "cursor-pointer"} flex-row items-center justify-center gap-x-3 rounded-large py-2.5`,
                    stepClassName,
                  )}
                  disabled={disableManualStepChange}
                ...
                >
                  ...
                  <div className="max-w-full flex-1 text-start">
                    <div
                      className={cn(
                        `text-small font-medium text-default-foreground transition-[color,opacity] duration-300 ${disableManualStepChange ? "" : "group-active:opacity-80"} lg:text-medium`,
                        {
